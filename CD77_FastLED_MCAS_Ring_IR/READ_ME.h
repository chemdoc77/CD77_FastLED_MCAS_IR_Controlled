...
This sketch is setup for a Lolin D32 and Lolin D32 Pro MCUs.  It will run on the Teensy 3.2 MCU 
but you have to make the following changes in the first tab:

change the value in line #13 to 6 and in line #55 to 10.
