//FastLED MCAS Ring IR Controlled Sketch by Chemdoc77
//MCAS = Multiple Complex Animations Sketch


//******This sketch is set up for the Lolin D32 and the Lolin D32 Pro MCUs*************

// to use this sketch for Teensy 3.2 MCU then, change the value in line #13 to 6 and in line #55 to 10.
